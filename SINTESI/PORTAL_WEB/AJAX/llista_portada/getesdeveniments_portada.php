...
if ($q == '')
	{?>
	<h3>Has de seleccionar una comarca!</h3><?php
	}
else
	{
	...
	WHERE e.id_esdeveniment=ll.id_esdeveniment and ll.id_poblacio=p.id_poblacio and ll.id_comarca='".$q."'";
	...
	else echo '<h3>No s\'han trobat esdeveniments en aquesta comarca.</h3>';
	}
?> 